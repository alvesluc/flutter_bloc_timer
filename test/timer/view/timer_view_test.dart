...
void main() {
  ...
  group('TimerView', () {
    ...
    testWidgets(
      'renders pause and reset button when timer is in progress',
      (tester) async {
    ...
    testWidgets(
      'renders play and reset button when timer is paused',
      (tester) async {
        when(() => timerBloc.state).thenReturn(TimerRunPause(59));
        await tester.pumpTimerView(timerBloc);
        expect(find.text('00:59'), findsOneWidget);
    ...
    testWidgets('timer started when play arrow is pressed', (tester) async {
      when(() => timerBloc.state).thenReturn(TimerInitial(60));
      await tester.pumpTimerView(timerBloc);
